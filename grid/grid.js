        ...
        for(var i in cdata['schema'])
        {
          ...
          for(var j = 0; j < cdata['records'].length; j++)
          {
            ...
            if(!this._isNullOrEmpty(cdata['schema'][i]['width']))
            {
              ...
              $(elementId).closest('td').width(width);
            ...
            if(!this._isNullOrEmpty(cdata['schema'][i]['height']))
            {
              ...
              $(elementId).closest('td').height(height);
            ...
            {        
              $(elementId).parent().hover(function (e){ $(this).children('.ui-grid-tooltip').toggle('fast', 'swing');} );
            }
          } 
      ...
      _buildGrid: function (itemsObject){
        ...
        for(var i in itemsObject['schema'])
        {
          ...
          if(itemsObject['schema'][i]['filterable'])
          {
            ...
            gridhtml += '<span class = "ui-grid-setting-dropdown">';
            gridhtml += '<select class = "ui-grid-setting-dropdown-select" id = "'+ curr.element.attr('id') + '_unique_filter_' + itemsObject['schema'][i]['name'] + '">';
          ...
          if($.isPlainObject(itemsObject['schema'][i]['actions']) && !$.isEmptyObject(itemsObject['schema'][i]['actions']))
          {
            ...
            actions += '<select  class = "ui-grid-setting-dropdown-select" id = "'+ curr.element.attr('id') + '_' + itemsObject['schema'][i]['name'] + '_action_dropdown">';
            
            if(!curr._isNullOrEmpty(itemsObject['schema'][i]['actionsMsg']))
            {
              actions += '<option value = "">' +itemsObject['schema'][i]['actionsMsg']+ '</option>';
            }
            else
            {
        ...
        if(curr.options.maxItemsPerPage !== null)
        {
          ...
          gridhtml += '<span id = "' + curr.element.attr('id') + '_pages_control" class = "grid-ui-icon-pages-control">';
          gridhtml += '<span id = "' + curr.element.attr('id') + '_prev_page" class = "grid-ui-icon-left-arrows" ></span>';
          gridhtml += '<span class = "ui-grid-page-dropdown">';
          gridhtml += '<select id = "' + curr.element.attr('id') + '_pages" class = "ui-grid-page-dropdown-select">';
